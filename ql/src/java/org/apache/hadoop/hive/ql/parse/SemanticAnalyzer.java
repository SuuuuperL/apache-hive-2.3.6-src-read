...
public class SemanticAnalyzer extends BaseSemanticAnalyzer {
     ...
     * @param qb
     * @param ctx_1
     * @throws SemanticException 参数 qb 是一个空的 QB，在不同 case 类型下对齐进行填满。
        ...
        if(ast.getToken() != null) {
            ...
            switch(ast.getToken().getType()) {
                ...
                case HiveParser.TOK_GROUPBY:
                    ...
                    /**
                     * TODO TOK_ROLLUP_GROUPBY
                     */
                case HiveParser.TOK_ROLLUP_GROUPBY:

                    /**
                     * TODO TOK_CUBE_GROUPBY
                     */
                case HiveParser.TOK_CUBE_GROUPBY:

                    /**
                     * TODO TOK_GROUPING_SETS
                     */
                ...
                /**
                 * TODO TOK_LATERAL_VIEW
                 */
                case HiveParser.TOK_LATERAL_VIEW:

                    /**
                     * TODO TOK_LATERAL_VIEW_OUTER
                     */
                case HiveParser.TOK_LATERAL_VIEW_OUTER:
                    // todo: nested LV
    ...
    */
     ...
     * @param plannerCtx
     * @return
     * @throws SemanticException TODO 由 抽象语法树 生成 解析树
     */
     ...
     * <p>
     * TODO 输入的 ASTTree 后续的 QB 的生成，逻辑执行计划、逻辑执行计划的优化、物理执行计划的切分、物理执行计划的优化、
     * TODO 以及 MapReduce 任务的生成全部都在这 1 万多行的代码里边的逻辑中。
     *
     * @param ast
     * @param plannerCtx
     * @throws SemanticException 物理执行计划和逻辑执行计划的区别：
     *                           逻辑执行计划是一个Operator图
     *                           物理执行计划是一个Task图
     *                           <p>
     *                           物理执行计划是把逻辑执行计划切分成子图
    ...
    void analyzeInternal(ASTNode ast, PlannerContext plannerCtx) throws SemanticException {
        ...
        /**
         * TODO 222222 ：解析 解析树/QB 生成一个 Operator Tree， 其实就是生成了一个 DAG
        ...
        /**
         * TODO 33333 ： 推导结果集模式 FieldSchema 就是包装一个字段 类型信息
         */
        ...
        /**
         * TODO 88888 可能的话，进行列裁剪（column pruning）
         */
        // 8. Generate column access stats if required - wait until column pruning takes place during optimization
        ...
        /**
         * TODO 9999999 生成物理执行计划  OperatorTree  ====> TaskTree
         */
        ...
        /**
         * TODO  10  封装要查询的列，到entity中。 FieldSchema  封装了列的信息
         */
        // 10. put accessed columns to ReadEntity
